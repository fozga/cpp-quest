...
- [Jason Turner — C++ Weekly: Lambda Captures](https://www.youtube.com/watch?v=cEQJCOpbGTk)
  ...
  captures.
- [Bartlomiej Filipek — "Lambda Tricks in C++20"](https://www.cppstories.com/2021/lambda-cpp20/)
  Blog post exploring modern lambda features including template lambdas and
  constexpr lambdas.
- [Microsoft Learn — Lambda expressions in C++](https://learn.microsoft.com/en-us/cpp/cpp/lambda-expressions-in-cpp)
  Tutorial-style explanation with diagrams of closure object layout.
